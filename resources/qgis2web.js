      ...
      map.getView().fit([-78096.229609, 6673970.932571, 44263.406472, 6746997.314675], map.getSize());

      var NO_POPUP = 0
      var ALL_FIELDS = 1

      popupLayers = ["2011_census_BAME (%)","IMD_2015_IMD Decile (where 1 is most deprived 10% of LSOAs)"];
